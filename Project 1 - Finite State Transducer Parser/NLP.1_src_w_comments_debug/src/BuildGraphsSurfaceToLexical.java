...
public class BuildGraphsSurfaceToLexical 
{
	...
	private void buildPronounGraph()
	{
		...
		Vertex v16 	= pronounGraph.insertVertex(16);
		Vertex v17 	= pronounGraph.insertVertex(17);
		Vertex v18 	= pronounGraph.insertVertex(18);
...
//		}
	...
	private void buildVerbGraph()
	{
		...
		Edge e12 = verbGraph.insertDirectedEdge(v4, v8, new EdgeTuple("ed#", "+past_form/past_part"));
		//Edge e70 = verbGraph.insertDirectedEdge(v33, v8, new EdgeTuple("", ""));
		//Edge e13 = verbGraph.insertDirectedEdge(v4, v8, new EdgeTuple("+past_part", "ed#"));
		//Edge e14 = verbGraph.insertDirectedEdge(v4, v34, new EdgeTuple("ed#", "+past_part"));
		//Edge e71 = verbGraph.insertDirectedEdge(v34, v8, new EdgeTuple("", ""));
		
		//Edge e15 = verbGraph.insertDirectedEdge(v6, v8, new EdgeTuple("+past_form", "#"));
		Edge e16 = verbGraph.insertDirectedEdge(v6, v8, new EdgeTuple("#", "+past_form/past_part"));
...
//		
		...
		Edge e65 = verbGraph.insertDirectedEdge(v32, v33, new EdgeTuple("s", ""));
		Edge e66 = verbGraph.insertDirectedEdge(v32, v11, new EdgeTuple("n", ""));

		Edge e67 = verbGraph.insertDirectedEdge(v33, v34, new EdgeTuple("", "+v"));
		Edge e68 = verbGraph.insertDirectedEdge(v34, v35, new EdgeTuple("", "+pres_form"));
		Edge e69 = verbGraph.insertDirectedEdge(v35, v8, new EdgeTuple("#", "+3sg"));
...
//		}
	...
	private void buildNounGraph()
	{
		...
		Edge e12 = nounGraph.insertDirectedEdge(v5, v7, new EdgeTuple("#", "+sg"));
...
//		}
	...
	private void buildERuleGraph()
	{
		...
		Edge e3 = eRuleGraph.insertDirectedEdge(v1, v2, new EdgeTuple("e", "^"));
		
		//Edge e4 = eRuleGraph.insertDirectedEdge(v2, v3, new EdgeTuple("", "e"));
		//Edge e5 = eRuleGraph.insertDirectedEdge(v2, v3, new EdgeTuple("e", ""));

		Edge e6 = eRuleGraph.insertDirectedEdge(v2, v3, new EdgeTuple("s", "s"));
		
		Edge e7 = eRuleGraph.insertDirectedEdge(v3, v0, new EdgeTuple("#", "#"));
