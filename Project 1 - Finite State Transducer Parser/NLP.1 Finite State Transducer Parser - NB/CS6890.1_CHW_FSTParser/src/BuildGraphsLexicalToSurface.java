...
public class BuildGraphsLexicalToSurface 
{
	...
	private void buildVerbGraph()
	{
		...
		verbGraph.insertDirectedEdge(v4, v8, new EdgeTuple("+past_form", "ed#"));
		verbGraph.insertDirectedEdge(v4, v8, new EdgeTuple("+past_part", "ed#"));
		
		verbGraph.insertDirectedEdge(v6, v8, new EdgeTuple("+past_form", "#"));
		verbGraph.insertDirectedEdge(v6, v8, new EdgeTuple("+past_part", "#"));
		...
		verbGraph.insertDirectedEdge(v7, v8, new EdgeTuple("+3sg", "^s#"));
		...
		verbGraph.insertDirectedEdge(v17, v18, new EdgeTuple("t", "u"));	
		verbGraph.insertDirectedEdge(v18, v19, new EdgeTuple("c", "g"));
		...
		verbGraph.insertDirectedEdge(v24, v25, new EdgeTuple("e", "o"));
		verbGraph.insertDirectedEdge(v25, v26, new EdgeTuple("a", "k"));
		verbGraph.insertDirectedEdge(v26, v27, new EdgeTuple("k", "e"));
		...
		verbGraph.insertDirectedEdge(v28, v29, new EdgeTuple("e", "a"));
		verbGraph.insertDirectedEdge(v29, v9, new EdgeTuple("e", "w"));
		...
		verbGraph.insertDirectedEdge(v32, v33, new EdgeTuple("+v", ""));
		
		verbGraph.insertDirectedEdge(v32, v11, new EdgeTuple("", "n"));
		
		verbGraph.insertDirectedEdge(v33, v34, new EdgeTuple("+pres_form", ""));
		
		verbGraph.insertDirectedEdge(v34, v8, new EdgeTuple("+3sg", "s#"));
	}
	...
	private void buildNounGraph()
	{
		...
		nounGraph.insertDirectedEdge(v4, v7, new EdgeTuple("+pl", "^s#"));
		...
		nounGraph.insertDirectedEdge(v18, v19, new EdgeTuple("o", "e"));
		nounGraph.insertDirectedEdge(v19, v20, new EdgeTuple("o", "e"));
	...
	private void buildERuleGraph()
	{
		...
		eRuleGraph.insertDirectedEdge(v1, v2, new EdgeTuple("^s#", "es"));
		eRuleGraph.insertDirectedEdge(v2, v0, new EdgeTuple("", "#"));		
		eRuleGraph.insertDirectedEdge(v0, v3, new EdgeTuple("c", "c"));
		eRuleGraph.insertDirectedEdge(v3, v1, new EdgeTuple("h", "h"));
		...
		{
			String result = other.substring(i, i+1);
			eRuleGraph.insertDirectedEdge(v3, v0, new EdgeTuple(result, result));
		}
